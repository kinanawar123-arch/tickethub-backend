        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    SlaHours = table.Column<int>(type: "int", nullable: false, defaultValue: 72),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Categories_SlaHours", "[SlaHours] > 0 AND [SlaHours] <= 720");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    MaxOpenTickets = table.Column<int>(type: "int", nullable: false, defaultValue: 10),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Agents_MaxOpenTickets", "[MaxOpenTickets] > 0 AND [MaxOpenTickets] <= 200");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReporterName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ReporterPhone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ReporterEmail = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    LocationAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tickets_ResolvedAfterCreated", "[ResolvedAt] IS NULL OR [ResolvedAt] >= [CreatedAt]");
                    table.CheckConstraint("CK_Tickets_Status", "[Status] BETWEEN 0 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorNameSnapshot = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedById = table.Column<int>(type: "int", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedById = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderNameSnapshot = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Body = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Agents_Department_IsActive",
                table: "Agents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketComments_Ticket_CreatedAt",
                table: "TicketComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistories_Ticket_ChangedAt",
                table: "TicketHistories",
                columns: new[] { "TicketId", "ChangedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_Agent_Status",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_Department_Status",
                table: "Tickets",
                columns: new[] { "DepartmentId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_DueAt_Unfinished",
                table: "Tickets",
                column: "DueAt",
                filter: "[Status] < 3");
